...
export default {
    ...
    mounted() {
        ...
        axios.get('/admin/api/pages/' + this.id).then(response => {
    ...
    methods: {
        ...
        deletePage() {
            this.alertConfirm("Are you sure you want to delete this page?", () => {
                ...
                axios.delete('/admin/api/pages/' + this.id, this.form).then(response => {
        ...
        save() {
            ...
            axios.post('/admin/api/pages/' + this.id, this.form).then(response => {
                this.status = '';
