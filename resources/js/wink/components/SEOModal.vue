<template>
    <modal @close="close">
        ...
        <div class="input-group">
            ...
            <textarea id="twitter_description" v-model="form.twitter_description" class="input" placeholder="Description in Twitter Card" />
        </div>
        ...
        <div class="input-group py-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <image-picker class="mt-4 mb-1" @changed="updateTwitterImage" @uploading="twitterImageUploading = true" />
                </div>

                <preloader v-if="twitterImageUploading" />

                <div v-if="!twitterImageUploading">
                    <div v-if="!form.twitter_image" class="w-16 h-16 rounded-full bg-light flex items-center justify-center text-4xl text-contrast">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="fill-current w-8">
                            <path d="M0 6c0-1.1.9-2 2-2h3l2-2h6l2 2h3a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V6zm10 10a5 5 0 1 0 0-10 5 5 0 0 0 0 10zm0-2a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
                        </svg>
                    </div>
                    <div v-if="form.twitter_image" class="w-16 h-16 rounded-full bg-cover" :style="{ backgroundImage: 'url(' + form.twitter_image + ')' }" />
                </div>
            </div>
        </div>
